...
//管脚定义修改区
/***********************************************************/
#define LCD_RS_H()		DDRA|=(1<<DDA0);PORTA|=(1<<PORTA0);
#define LCD_RS_L()		DDRA|=(1<<DDA0);PORTA&=~(1<<PORTA0);
#define LCD_RW_H()		DDRA|=(1<<DDA1);PORTA|=(1<<PORTA1);
#define LCD_RW_L()		DDRA|=(1<<DDA1);PORTA&=~(1<<PORTA1);
#define LCD_E_H()		DDRA|=(1<<DDA2);PORTA|=(1<<PORTA2);
#define LCD_E_L()		DDRA|=(1<<DDA2);PORTA&=~(1<<PORTA2);
